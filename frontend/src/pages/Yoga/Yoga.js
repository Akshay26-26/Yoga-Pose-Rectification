    ...
    return (
      <div className="yoga-container">
        <div className="performance-container">
            ...
            {showscore && <div className = "pose-performance"><h4>Score : {Math.round(showscore)} </h4>{Math.round(showscore)}</div>}
            {complement && <div className = "pose-performance">{complement}</div>}
          </div>
        <div>
